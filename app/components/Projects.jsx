        ...
        <div className="relative lg:w-[55%] bg-black flex flex-col shrink-0">
          <div className="relative flex-1 min-h-[240px] sm:min-h-[320px] lg:min-h-0 group/photo">
            ...
            <button
              ...
              className="absolute top-3 left-3 opacity-100 lg:opacity-0 lg:group-hover/photo:opacity-100 transition-opacity duration-200
                text-white bg-black/50 hover:bg-black/80 p-2 lg:p-1.5 rounded-lg"
              title="Full screen">
